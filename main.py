...
BULLET_HIT_SOUND = pygame.mixer.Sound("Assets/invaderkilled.wav")
BULLET_FIRE_SOUND = pygame.mixer.Sound("Assets/shoot.wav")
...
REDS_PACESHIP_IMAGE=pygame.image.load(
    os.path.join("Assets", "spaceship_red.png"))
RED_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(REDS_PACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)),270)
